...
\begin{enumerate}
    \item 预测类任务，如电力负荷预测、风电功率预测、光伏功率预测和建筑能耗预测
    \item 识别与诊断类任务，如故障识别、异常检测和设备健康评估
    \item 决策与控制类任务，如微电网能量管理、储能调度和需求响应优化
\end{enumerate}
...
\begin{center}
\captionof{table}{智慧能源典型任务、输入数据与常用模型\\Table~\thetable\ Typical tasks, inputs, and models in smart energy}
\vspace{3pt}
{\fontsize{8.6pt}{12pt}\selectfont
\setlength{\tabcolsep}{2pt}
\begin{tabular}{@{}p{0.20\columnwidth}p{0.40\columnwidth}p{0.28\columnwidth}@{}}
\toprule
任务 & 常见输入数据 & 常用模型 \\
\midrule
